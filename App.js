...
const TUTORIAL_STEPS = [
  {
    ...
    body: 'Go to Profile → Edit to set your name, belt, and academy. Search for your gym by name — if it\'s not listed yet, create it and your teammates can find and join it too.',
    tip: 'Joining the correct academy is important — it determines who you see on the Academy leaderboard and who your coach can see in their dashboard.',
    tab: 'Profiles',
  },
  {
    icon: '🥋',
  ...
  {
    icon: '⚡',
    title: 'Track every event during the roll',
    body: 'Use the score sheet to record sweeps, takedowns, guard passes, and submissions as they happen — for both you and your opponent.',
  ...
  },
  {
    ...
    body: 'After training, open the Journal tab and log what you worked on. Every technique gets a tag — Learned, Tried, or Finished. Your coach may also post class logs for you to import.',
  ...
  },
  {
    ...
    body: 'Use the custom technique field to add every submission or technique you attempted or completed — even if it wasn\'t in the official class plan.',
    tip: '"Tried" means you went for it but didn\'t finish. "Finished" means you completed it. This builds your finish rate data over time and powers the technique insights.',
    tab: 'Journal',
  },
  {
    icon: '🎬',
    title: 'Watch technique videos in the Journal',
    body: 'Your coach can attach YouTube reference videos to techniques in class logs. Tap the thumbnail to watch inline without leaving the app. You can also search YouTube and attach your own videos when logging manually.',
    tip: null,
    tab: 'Journal',
  },
  {
    ...
    body: 'The Charts tab tracks your win rate, submission rates, consistency streaks, and technique patterns. The Journal\'s By Technique view shows your full history with each technique including reference videos.',
    tip: 'Insights get smarter over 25–50 logged sessions. The more consistently you log, the more accurate the patterns become.',
    tab: 'Charts',
  },
  {
    icon: '🏫',
    title: 'See how you compare in Academy',
    body: 'The Academy tab shows your gym\'s leaderboard ranked by training days, rolls logged, and milestone badges. Your row is always highlighted so you can see where you stand.',
    tip: 'Streaks reset if you miss a day — logging even a short drilling session keeps your streak alive and your training day count accurate.',
    tab: 'Academy',
  },
  {
    icon: '🔔',
    title: 'Import your coach\'s class logs',
    body: 'When your coach posts a class, a teal banner appears on every screen. Tap it to open your Journal, set your outcomes for each technique, then add anything extra you tried or finished.',
    tip: 'Importing a class log automatically marks that day on your consistency calendar. Tap "Didn\'t attend" to dismiss a log without importing it.',
    tab: 'Journal',
  },
];
